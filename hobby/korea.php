<?
    ...
    //state query
    $state_sql = "select * from korea_state";
...
?>
<!-- The Modal -->
<div id="modal_korea" class="modal">
   <!-- Modal content -->
   <div class="modal-content">
    <p class="country">KOREA</p>
    <div id="chartdiv_korea"></div>
...
<?
    //city query
    $city_sql = "select * from korea_city where state_id='".$state_id."'";
...
<?
    ...
    //place query
    $place_sql = "select * from korea_place where city_id='".$city_id."'" ;
